...
def build_train_transform(cfg):
    ...
    transform = transforms.Compose([
                                    ...
                                    # transforms.RandomResizedCrop(cfg.DATA.RESIZE),
    ...
    transform.transforms.insert(0, RandAugment(cfg.DATA.RAND_N, cfg.DATA.RAND_M))
    return transform
...
class ColorJitter(object):
    """
    Reference : https://github.com/clovaai/CutMix-PyTorch/blob/master/utils.py
    """
